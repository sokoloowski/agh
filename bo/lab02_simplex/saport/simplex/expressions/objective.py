...
class Objective: 
    """
        ...
        invert():
            inverts objective, keeping the "objective variable coefficient" intact  
    ...
    def __init__(self, expression: sseexp.Expression, type: ObjectiveType = ObjectiveType.MAX, coefficient: float = 1.0):
